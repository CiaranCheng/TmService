...
namespace TmService.Utils
{
    public class DataBaseLayer
    {
        ...
        {
            this.connectionString = string.Format("data source={0};user id={1};pwd={2};", ConfigurationManager.AppSettings["DataSource"], ConfigurationManager.AppSettings["User"], ConfigurationManager.AppSettings["Password"]);
